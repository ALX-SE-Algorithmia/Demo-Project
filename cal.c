...
/*Command line calculator using function pointer that prompt the user to select an operation and enter two number to execute the operation.*/
...
float sub(float n1, float n2) {return (n1 - n2);}
 ...
 int main()
{
        /*Pointer to an array of function pointers. The array will contain pointers to the four functions that were declared earlier*/
